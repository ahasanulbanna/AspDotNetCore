...
{
    public partial class TestNopDBContext : DbContext
    {
        public TestNopDBContext()
        {
        }

        public TestNopDBContext(DbContextOptions<TestNopDBContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<PivotTableEx> PivotTableices { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-3FHN5HM\\SQLEXPRESS;Database=TestNopDB; User Id=sa; Password=B@ngl@d3sh;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PivotTableEx>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("PivotTableEx");
            ...
            {
                entity.HasKey(e => e.UserTrainingId);

                entity.ToTable("training_details");

                entity.Property(e => e.UserTrainingId)
                    .ValueGeneratedNever()
                    .HasColumnName("user_training_id");
